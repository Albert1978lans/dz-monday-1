...
function Clock() {
    ...
    const stringDate = `${getValue('ru', {day: 'numeric', month: 'numeric', year: 'numeric'})}` || <br/> // день.месяц.год (01.02.2022) // пишут студенты, варианты 01.02.0123/01.02.-123/01.02.12345 не рассматриваем

    // день недели на английском, месяц на английском (https://learn.javascript.ru/intl#intl-datetimeformat)
    const stringDay = `${getValue('en', {weekday: "long"})}` || <br/> // пишут студенты
    const stringMonth = `${getValue('en', {month: "long"})}` || <br/> // пишут студенты
